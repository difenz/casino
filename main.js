...
var Slot = function(options, canvasNode) {
    ...
    var defaultOptions = {
        ...
        soundWinUrl: "winn.mp3",
        soundReelStopUrl: "magic.wav",
        ...
        startingCredits: 777,   // начальная сумма на счету
        ...
        reelAreaHeight: 190,
        displays: {
            pays: new Display("Выигрыш", 32, 250, 112, 68, 4),
            credits: new Display("Кредиты", 165, 250, 112, 68, 4),
            bet: new Display("Ставка", 310, 250, 36, 68, 1)
        }
    };
...
slot.buttons.push(
    new Button("Крутим!", 398, 320, 150, 80).on('click', function(e) {
        slot.betMax();
    })
);
